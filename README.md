...
- This sitesuggest movies based on users location and city's weather.It also shows different platform like Amzon Prime, Netflix on a single Screen. Trailer of the movies can be watched easily with a single click[Movie-Weather-App](https://movie-weather-app.web.app/)
